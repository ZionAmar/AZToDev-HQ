...
**Source:** Noa → Keshet (`32-delivery-lead`)  
**Date:** 2026-09-09  
**Status:** Plan-only — no repo create/push until founder PIN + `productWorkEnabled`  
...
## Linear — 4 staged issues (EMET team)

**Project:** [KidNest — העלאה לגיטהאב](https://linear.app/my-company1460/project/kidnest-העלאה-לגיטהאב)

| ID | Stage | Owner | Gate | Linear |
|----|-------|-------|------|--------|
...
**Replaces:** generic holding issue [EMET-66](https://linear.app/my-company1460/issue/EMET-66) (canceled when concrete bet landed).

Duplicate draft issues EMET-125..128 were canceled; canonical set is EMET-129..132.
...
- This file: `ops/intake/ideas/IDEA-kidnest-github-upload.md`
- Board: `ops/intake/kidnest-github-board.json`
- Manifest: `ops/linear-kidnest-github-issues.json`
- Publish script: `runtime/scripts/kidnest-github-linear-publish.mjs`
