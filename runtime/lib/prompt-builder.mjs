...
אסור «ריצה כפולה» / «יש תוצאה טרייה» — רק אם LIVE FLOW מראה שמישהו באמת רץ על אותה בקשה.
קישור למומחה: רק https://cursor.com/agents/bc-… אמיתי מהסשן; בלי קישור עדיף מ-cursor.com כללי.
