# KidNest → Private GitHub — Repo Plan (KNU-01)

**Author:** Keshet (`32-delivery-lead`)  
**Date:** 2026-09-09  
**Status:** Plan-only — no repo create/push until founder PIN on KNU-03  
**Board:** `ops/intake/kidnest-github-upload-board.json`  
**Linear project:** KidNest — GitHub upload (separate from KidNest — ביקורת פרודקשן)  
...
## Secrets scrub checklist (Nadav — KNU-02)
...
**Gate:** KNU-03 (create repo + push) requires founder PIN.

---

## `factory.json` registration (KNU-04 — after repo exists)
...
## Linear — 4 phases, 4 tasks (EMET team)

**Project:** KidNest — GitHub upload (separate from audit project)

| Phase | Task | Owner | Gate |
|-------|------|-------|------|
| P1 | KNU-01 — Linear project + repo plan (this doc) | `32-delivery-lead` | None |
| P2 | KNU-02 — PC folder scan + secrets filter | `34-pc-ops` (Nadav) | PC on |
| P3 | KNU-03 — Create private repo + first push | `34-pc-ops` | PIN |
| P4 | KNU-04 — Register in factory.json + close initiative | `32-delivery-lead` | After KNU-03 |

WIP=1. Sequential through P2→P3→P4 for repo mutations.
...
| Duplicate Linear projects | One upload project (KNU); audit stays in separate project |
...
- This file: `ops/meetings/kidnest-github-upload/KNU-01-repo-plan.md`
- Board: `ops/intake/kidnest-github-upload-board.json`
