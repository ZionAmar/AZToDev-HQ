...
### 2026-09-10 · pci-16-cake-recipe-verbatim-outbox
- do: When PC shell is broken (0xC0000142), embed FULL raw file contents in outbox so 34-pc-ops can Write locally without git fetch
- dont: Tell Nadav to pull HQ branches when his shell cannot run git — give copy-paste payloads instead
- note: PCI-16 cake-recipe DevOps files verbatim in outbox from cursor/cake-recipe-docker-pages-stage-18eb
